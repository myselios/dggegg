...
| # | 기능 | 담당 | 의존관계 | 상태 |
|---|------|------|----------|------|
| B8 | 성적 추이 차트 (Recharts) | frontend-dev | 없음 | ⬜ 미시작 |
| B9 | Dashboard 미니 캘린더 | frontend-dev | 없음 | ⬜ 미시작 |
| B10 | 캘린더 충돌 감지 | frontend-dev | B1 | ⬜ 미시작 |
| B11 | 에러 핸들링 통합 (ActionResult) | backend-dev | B6 | ⬜ 미시작 |
...
| I5 | 🟡 중간 | 비밀번호 평문 비교 (timing attack) | 2026-02-14 |
| I6 | 🟡 중간 | SWR 글로벌 설정 없음 | 2026-02-14 |
| I7 | 🟡 중간 | 환경변수 non-null assertion | 2026-02-14 |
